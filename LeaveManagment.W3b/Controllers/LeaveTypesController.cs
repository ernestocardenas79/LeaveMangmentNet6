...
namespace LeaveManagment.W3b.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var viewdata = _mapper.Map<List<IndexVM>>(leaveTypes);
        ...
        public async Task<IActionResult> Create([Bind("Name,DefaultDays,Id,CreatedBy,DateModified")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,DefaultDays,Id,CreatedBy,DateModified")] LeaveType leaveType)
        {
            if (id != leaveType.Id)
            {
                return NotFound();
